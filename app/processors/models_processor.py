...
class ModelsProcessor(QtCore.QObject):
    ...
    def apply_dfl_xseg(self, img, amount, mouth, parameters, dfl_inside_amount: float = 1.0, dfl_outside_amount: float = 1.0, swapped_contour_mask_256=None, regional_adjustments=None):
        return self.face_masks.apply_dfl_xseg(img, amount, mouth, parameters, dfl_inside_amount=dfl_inside_amount, dfl_outside_amount=dfl_outside_amount, swapped_contour_mask_256=swapped_contour_mask_256, regional_adjustments=regional_adjustments)
